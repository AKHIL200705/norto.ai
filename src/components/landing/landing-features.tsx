        ...
        >
          {FEATURES.map((f) => (
            <motion.article
              ...
              className={`group glass relative flex flex-col gap-4 overflow-hidden rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-emerald-900/10 hover:ring-1 hover:ring-emerald-500/30 ${f.span ?? ''}`}
            >
              <span
                aria-hidden
