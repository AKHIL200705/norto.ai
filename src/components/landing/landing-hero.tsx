    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8 text-center z-10">
        ...
        >
          ...
          <h1 className="text-balance text-4xl font-extrabold leading-[1.1] tracking-tight text-[#3D4852] dark:text-[#E2E8F0] sm:text-6xl lg:text-7xl font-display">
            Your{' '}
          ...
          <p className="max-w-2xl text-pretty text-base text-[#6B7280] dark:text-[#94A3B8] font-medium sm:text-xl leading-relaxed">
